...
public class Swat extends EntityPigZombie{
	...
	public static ItemStack[] equip = new ItemStack[]{ItemConfiguration.SWAT_HELMET.getItemStack(),
		  											  ItemConfiguration.SWAT_CHESTPLATE.getItemStack(),
		  											  ItemConfiguration.SWAT_LEGGINGS.getItemStack(),
		  											  ItemConfiguration.SWAT_BOOTS.getItemStack(),
		  											  ItemConfiguration.SWAT_WEAPON.getItemStack()};
